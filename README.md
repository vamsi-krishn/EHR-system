# ZIKITESVOTE - Blockchain Voting System

ZIKITESVOTE is a secure, transparent blockchain-based voting system designed for university elections at Nnamdi Azikiwe University. The system leverages Ethereum blockchain technology to ensure tamper-proof voting, real-time results, and complete auditability.

## Features

- **Secure Authentication**: Wallet-based authentication with university student verification
...
- **Multiple Categories**: Support for various election categories and positions
...
1. Clone the repository:
   \`\`\`bash
   git clone https://github.com/your-username/zikitesvote.git
   cd zikitesvote
   \`\`\`
...
1. Verify eligibility with your student credentials
...
Let's update the vote page to include the logo and support for categories:

```typescriptreact file="app/vote/page.tsx"
